...
{	
    ...
    if (iIndex > -1) 
    {
        ...
        CPrintToChat(client, "{blue}[{default}RATE{blue}]{default} Your netset changed from {blue}%d{default}/{blue}%d{default}/{olive}%d{default} to {blue}%d{default}/{blue}%d{default}/{olive}%d{default}%s", 
