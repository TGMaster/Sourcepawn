...
public OnPluginStart()
{
    ...
    cvar_SurrenderTimeLimit = CreateConVar("l4d2_tankswap_timelimit", "20", " How many seconds can a primary Tank Player surrender control ", FCVAR_PLUGIN|FCVAR_NOTIFY);
...
static CallSurrenderMenu()
{
    ...
    SetMenuTitle(surrenderMenu, "Choose Play To Pass Tank");
    ...
    AddMenuItem(surrenderMenu, "0", "Anyone!");
...
public Action:TS_Display_Auto_MenuToTank(Handle:timer)
{
    ...
    SetMenuTitle(surrenderMenu, "Choose Player To Pass");
    ...
    AddMenuItem(surrenderMenu, "99", "Anyone");
